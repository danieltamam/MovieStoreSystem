...
namespace MovieShop
{
     public class Director
    {
        ...
        public Director(string name)//there is the prop in the ctor , that is allowd to keep the encapsulation and only leggal info will be able to set
        {
            Name = name;
        }
